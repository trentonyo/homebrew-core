class PostgresqlAT17 < Formula
  ...
  depends_on "docbook" => :build # TODO: Check on this for stable release
  depends_on "docbook-xsl" => :build # TODO : Check on this for stable release
  ...
  uses_from_macos "bison" => :build # TODO: Check on this for stable release
  uses_from_macos "flex" => :build # TODO: Check on this for stable release
